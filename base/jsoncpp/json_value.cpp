...
std::string 
Value::toStyledJsonString() const                                                                                                                                                
{
	StyledWriter writer;
	return writer.write( *this ); 
}
...
std::string 
Value::toBinary() const
{
	BinaryWriter writer;      
	return writer.write( *this ); 
}

bool Value::decodeJson(const std::string & sJsonStr)
{
	Reader reader;
	return reader.parse(sJsonStr, *this);
}

bool Value::decodeJson(const char * pszData, size_t size)
{
	Reader reader;
	return reader.parse(pszData, pszData + size, *this);
}

bool Value::decodeBinary(const std::string & sBuf)
{
	BinaryReader reader;
	return reader.parse(sBuf, *this);
}

bool Value::decodeBinary(const char * pszData, size_t size)
{
	BinaryReader reader;
	return reader.parse(pszData, size, *this);
}

bool Value::hasKey(const char * key) const
{
	const Value *value = &((*this)[key]);
	return value != &null;
}
