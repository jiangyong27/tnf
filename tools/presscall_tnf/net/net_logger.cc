...
void CLogger::Log(int level, const char *format, ...)
{
    ...
    int len = snprintf(time_tmp, 30, "[%04d-%02d-%02d %02d:%02d:%02d]%ld", 1900+m_time.tm_year, m_time.tm_mon+1, \
           m_time.tm_mday, m_time.tm_hour, m_time.tm_min, m_time.tm_sec,tv.tv_usec);
